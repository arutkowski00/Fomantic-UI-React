        ...
        <Tab.Pane style={{ fontSize: 'inherit' }}>
          ...
          <CodeSnippet
            ...
            value={`
              <link
                rel="stylesheet"
                href="//cdn.jsdelivr.net/npm/fomantic-ui@${props.versions.sui}/dist/semantic.min.css"
              />
            `}
          />
        </Tab.Pane>
    ...
    },
    {
      ...
      render: () => (
        <Tab.Pane style={{ fontSize: 'inherit' }}>
          ...
          <CodeSnippet fitted label='index.js' value="import 'fomantic-ui-css/semantic.min.css'" />
        </Tab.Pane>
      ),
    },
    {
